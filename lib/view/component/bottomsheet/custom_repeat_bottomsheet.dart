...
//     // Lấy giá trị ngày đã chọn từ picker
//     int daysInterval = _selectedValue;  // Số ngày đã chọn
//     String title = 'Thông báo lặp lại';
//     String body = 'Sự kiện sẽ diễn ra sau mỗi $_selectedValue ngày';
//
//     // Gọi phương thức để gửi thông báo lặp lại
//     NotificationService.setPeriodicNotification(
//       id: 1,  // ID thông báo
//       title: title,
//       body: body,
//       isPlaySound: true,
//       daysInterval: daysInterval,  // Truyền số ngày vào đây
//     );
//
