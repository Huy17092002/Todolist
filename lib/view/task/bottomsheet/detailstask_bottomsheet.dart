...
//   final Task task;
//   final TaskList taskList;
//   final Function(Task, String, String) onSaveChanges;  // Callback function
//
//   const DetailsTaskBottomsheet({
//     super.key,
//     required this.task,
//     required this.taskList,
//     required this.onSaveChanges,  // Initialize callback
//   });
//
//   @override
//   State<DetailsTaskBottomsheet> createState() => _DetailsTaskListPageBottomsheetState();
// }
//
// class _DetailsTaskListPageBottomsheetState extends State<DetailsTaskBottomsheet> {
//   late TextEditingController titleController;
//   late TextEditingController descriptionController;
//   DateTime? reminderTime;
//
...
//                     ),
//                     onPressed: () {
//                       // When save is pressed, call the callback to pass changes back to NewReminderBottomsheet
...
//   final Task task;
//   final TaskList taskList;
//   final Function(Task, String, String) onSaveTaskDetails;  // Callback to save task changes
//   final Function(TaskList) onSaveTaskListChanges;  // Callback to save task list changes
//
//   const DetailsTaskBottomsheet({
//     super.key,
//     required this.task,
//     required this.taskList,
//     required this.onSaveTaskDetails, // Callback to save task
//     required this.onSaveTaskListChanges, // Callback to save task list
//   });
//
//   @override
//   State<DetailsTaskBottomsheet> createState() => _DetailsTaskListPageBottomsheetState();
...
//                       widget.onSaveTaskDetails(
//                         widget.task,
//                         titleController.text,
//                         descriptionController.text,
//                       );
//
//                       // Update task list information (optional: task list could also be updated)
//                       widget.onSaveTaskListChanges(widget.taskList);
//
//                       Navigator.pop(context);
//                     },
//                   ),
